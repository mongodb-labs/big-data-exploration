...
public class PageRank extends Configured implements Tool{
    ...
    public void oneIteration(String numTrials, String inputString, String outputString) 
        ...
        while (true) {
            ...
            double totalResidual = ((double) job.getCounters().
                    findCounter(PageRank.RanCounters.RESIDUAL).getValue())/ residualFactor;
            if (totalResidual < 0) {
    ...
    public int run(String[] arg0) throws Exception {
        ...
        try {
            oneIteration(numTrials, inputString, outputString);
        } catch (Exception e) {
            sb.append("\n");
