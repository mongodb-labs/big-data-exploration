...
// put "Flights Out of each state"
d3.select("body").append("h2").text("Flights Out of each State");
d3.select("body").append("p").text("Click state to zoom in and zoom out!");

mapdata(flightsout);
// put "Flights Into each state"
d3.select("body").append("h2").text("Flights Into each State");
d3.select("body").append("p").text("Click state to zoom in and zoom out!");
mapdata(flightsin);
